...
class TagsContext extends BaseContext
{
    ...
    {
        $expectedColumns = array('id', 'name', 'no_script_uri', 'code', 'triggers', 'created_at', 'updated_at', 'document_write', 'disable_in_debug_mode', 'is_active', 'template', 'template_options', 'container', 'priority', 'respect_visitors_privacy');
