 ...
 */
class Integration extends \SevenTag\Api\SecurityBundle\Entity\Integration implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'name', 'user', 'id', 'randomId', 'secret', 'redirectUris', 'allowedGrantTypes', 'createdAt', 'updatedAt');
        }
