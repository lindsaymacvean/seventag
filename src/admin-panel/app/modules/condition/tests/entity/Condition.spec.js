...
describe('Unit: Condition entity', () => {

    var conditionResource, condition;

    beforeEach(angular.mock.module('clearcode.tm.condition'));
    ...
    beforeEach(angular.mock.inject([
        ...
        (_conditionResource_) => {
            ...
            condition = conditionResource.getEntityObject();
