 ...
 */
class AuthCode extends \SevenTag\Api\SecurityBundle\Entity\AuthCode implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'redirectUri', 'id', 'client', 'token', 'expiresAt', 'scope', 'user');
        }
