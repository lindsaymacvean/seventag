...
describe('Unit: SelectorController', () => {
    ...
    describe('when toggleVariablesList execute', () => {
        beforeEach(()=> {
            SelectorController.init(element, ngModelController);
            SelectorController.ulElement.hasClass = (arg) => {
                return listOpened;
            }
        });
        ...
        it('should add {{ when element value is empty and list is closed', () => {
            ...
            listOpened = false;
            SelectorController.toggleVariablesList({stopPropagation:function(){return true}});
            expect(element.val()).toBe('{{');
        });
    ...
    describe('when closeVariablePrompt execute', () => {
        beforeEach(()=> {
            ...
            SelectorController.ulElement.removeClass = (arg) => {
                return true;
            };
        });
        it('should remove {{ from the end of element value', () => {
            ...
            SelectorController.closeVariablePrompt({stopPropagation:function(){return true}});
            expect(element.val()).toBe('test');
        });
