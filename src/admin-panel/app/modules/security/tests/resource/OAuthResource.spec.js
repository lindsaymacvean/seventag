...
/* eslint-enable */
    ...
    var oauthResource, $httpBackend, tokenStorage;
    ...
    describe('when call post method', () => {
        ...
        it('should return proper object', () => {
            ...
            var respondedObject = oauthResource.post('test_user', 'test_password');
    ...
    describe('when call logout method', () => {
        ...
        it('should return proper object', () => {
            ...
            var respondedObject = oauthResource.logout();
    ...
    describe('when call refreshToken method', () => {
        ...
        it('should return proper object', () => {
            ...
            var respondedObject = oauthResource.refreshToken(response.access_token);
