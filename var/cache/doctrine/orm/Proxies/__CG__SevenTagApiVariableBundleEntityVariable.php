...
namespace Proxies\__CG__\SevenTag\Api\VariableBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Variable extends \SevenTag\Api\VariableBundle\Entity\Variable implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'name', 'description', 'type', 'value', 'container', 'options', 'createdAt', 'updatedAt', 'version', 'accessId');
        }
