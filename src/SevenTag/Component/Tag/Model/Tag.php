...
class Tag implements TagInterface
{
     ...
     * {@inheritDoc}
     */
    public function getNoScriptUri()
    {
        return $this->noScriptUri;
    }

    /**
     * {@inheritDoc}
     */
    public function setNoScriptUri($noScriptUri)
    {
        if (empty($noScriptUri)) {
            $noScriptUri = null;
        }

        $this->noScriptUri = $noScriptUri;
    }
