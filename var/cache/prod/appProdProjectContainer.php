...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'dbname' => 'seventag1', 'user' => 'seventag', 'password' => 'QdXrga5FdpN2Xosp', 'charset' => 'UTF8', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), $b, array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array(($this->targetDirs[3].'/vendor/sonata-project/notification-bundle/Resources/config/doctrine') => 'Sonata\\NotificationBundle\\Entity', ($this->targetDirs[3].'/vendor/friendsofsymfony/oauth-server-bundle/FOS/OAuthServerBundle/Resources/config/doctrine') => 'FOS\\OAuthServerBundle\\Entity'));
        $a->setGlobalBasename('mapping');
        $b = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'/src/SevenTag/Api/ContainerBundle/Resources/config/doctrine') => 'SevenTag\\Api\\ContainerBundle\\Entity', ($this->targetDirs[3].'/src/SevenTag/Api/TagBundle/Resources/config/doctrine') => 'SevenTag\\Api\\TagBundle\\Entity', ($this->targetDirs[3].'/src/SevenTag/Api/UserBundle/Resources/config/doctrine') => 'SevenTag\\Api\\UserBundle\\Entity', ($this->targetDirs[3].'/src/SevenTag/Api/SecurityBundle/Resources/config/doctrine') => 'SevenTag\\Api\\SecurityBundle\\Entity', ($this->targetDirs[3].'/src/SevenTag/Api/TriggerBundle/Resources/config/doctrine') => 'SevenTag\\Api\\TriggerBundle\\Entity', ($this->targetDirs[3].'/src/SevenTag/Api/AppBundle/Resources/config/doctrine') => 'SevenTag\\Api\\AppBundle\\Entity', ($this->targetDirs[3].'/src/SevenTag/Api/VariableBundle/Resources/config/doctrine') => 'SevenTag\\Api\\VariableBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_cd3bd6b1a73affd20ab8d3525e35f8476f3a37c692e859c5c6b29dc9e40c8393');
        return $instance;
    }
    ...
    {
        return $this->services['gaufrette.container_library'] = new \Gaufrette\Filesystem(new \Gaufrette\Adapter\Local(($this->targetDirs[3].'/app/../web/containers'), true));
    }
    protected function getGaufrette_ContainerLibraryMockService()
    {
        return $this->services['gaufrette.container_library_mock'] = new \Gaufrette\Filesystem(new \Gaufrette\Adapter\Local(($this->targetDirs[3].'/app/../tests'), true));
    }
    ...
    {
        $a = new \Metadata\Driver\FileLocator(array('Symfony\\Bundle\\FrameworkBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/config/serializer'), 'Symfony\\Bundle\\SecurityBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/config/serializer'), 'Symfony\\Bundle\\TwigBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/config/serializer'), 'Symfony\\Bundle\\MonologBundle' => ($this->targetDirs[3].'/vendor/symfony/monolog-bundle/Resources/config/serializer'), 'Symfony\\Bundle\\SwiftmailerBundle' => ($this->targetDirs[3].'/vendor/symfony/swiftmailer-bundle/Resources/config/serializer'), 'Symfony\\Bundle\\AsseticBundle' => ($this->targetDirs[3].'/vendor/symfony/assetic-bundle/Resources/config/serializer'), 'Sensio\\Bundle\\FrameworkExtraBundle' => ($this->targetDirs[3].'/vendor/sensio/framework-extra-bundle/Resources/config/serializer'), 'Doctrine\\Bundle\\DoctrineBundle' => ($this->targetDirs[3].'/vendor/doctrine/doctrine-bundle/Resources/config/serializer'), 'Doctrine\\Bundle\\MigrationsBundle' => ($this->targetDirs[3].'/vendor/doctrine/doctrine-migrations-bundle/Doctrine/Bundle/MigrationsBundle/Resources/config/serializer'), 'FOS\\RestBundle' => ($this->targetDirs[3].'/vendor/friendsofsymfony/rest-bundle/FOS/RestBundle/Resources/config/serializer'), 'FOS\\UserBundle' => ($this->targetDirs[3].'/src/SevenTag/Api/UserBundle/Resources/config/serializer/fos'), 'FOS\\OAuthServerBundle' => ($this->targetDirs[3].'/src/SevenTag/Api/SecurityBundle/Resources/config/serializer/fos'), 'FOS\\HttpCacheBundle' => ($this->targetDirs[3].'/vendor/friendsofsymfony/http-cache-bundle/Resources/config/serializer'), 'Knp\\Bundle\\GaufretteBundle' => ($this->targetDirs[3].'/vendor/knplabs/knp-gaufrette-bundle/Knp/Bundle/GaufretteBundle/Resources/config/serializer'), 'JMS\\SerializerBundle' => ($this->targetDirs[3].'/vendor/jms/serializer-bundle/JMS/SerializerBundle/Resources/config/serializer'), 'Liip\\MonitorBundle' => ($this->targetDirs[3].'/vendor/liip/monitor-bundle/Resources/config/serializer'), 'Nelmio\\ApiDocBundle' => ($this->targetDirs[3].'/vendor/nelmio/api-doc-bundle/Nelmio/ApiDocBundle/Resources/config/serializer'), 'Stof\\DoctrineExtensionsBundle' => ($this->targetDirs[3].'/vendor/stof/doctrine-extensions-bundle/Stof/DoctrineExtensionsBundle/Resources/config/serializer'), 'Sonata\\NotificationBundle' => ($this->targetDirs[3].'/vendor/sonata-project/notification-bundle/Resources/config/serializer'), 'SevenTag\\Api\\ContainerBundle' => ($this->targetDirs[3].'/src/SevenTag/Api/ContainerBundle/Resources/config/serializer'), 'SevenTag\\Api\\TagBundle' => ($this->targetDirs[3].'/src/SevenTag/Api/TagBundle/Resources/config/serializer'), 'SevenTag\\Api\\TestBundle' => ($this->targetDirs[3].'/src/SevenTag/Api/TestBundle/Resources/config/serializer'), 'SevenTag\\Api\\UserBundle' => ($this->targetDirs[3].'/src/SevenTag/Api/UserBundle/Resources/config/serializer'), 'SevenTag\\Api\\SecurityBundle' => ($this->targetDirs[3].'/src/SevenTag/Api/SecurityBundle/Resources/config/serializer'), 'SevenTag\\Api\\TriggerBundle' => ($this->targetDirs[3].'/src/SevenTag/Api/TriggerBundle/Resources/config/serializer'), 'SevenTag\\Api\\AppBundle' => ($this->targetDirs[3].'/src/SevenTag/Api/AppBundle/Resources/config/serializer'), 'SevenTag\\Api\\VariableBundle' => ($this->targetDirs[3].'/src/SevenTag/Api/VariableBundle/Resources/config/serializer'), 'SevenTag\\Plugin\\PiwikCustomTemplateBundle' => ($this->targetDirs[3].'/src/SevenTag/Plugin/PiwikCustomTemplateBundle/Resources/config/serializer'), 'SevenTag\\Plugin\\ClickTaleCustomTemplateBundle' => ($this->targetDirs[3].'/src/SevenTag/Plugin/ClickTaleCustomTemplateBundle/Resources/config/serializer'), 'SevenTag\\Plugin\\CrazyEggCustomTemplateBundle' => ($this->targetDirs[3].'/src/SevenTag/Plugin/CrazyEggCustomTemplateBundle/Resources/config/serializer'), 'SevenTag\\Plugin\\SentryBundle' => ($this->targetDirs[3].'/src/SevenTag/Plugin/SentryBundle/Resources/config/serializer'), 'SevenTag\\Plugin\\FacebookRetargetingPixelCustomTemplateBundle' => ($this->targetDirs[3].'/src/SevenTag/Plugin/FacebookRetargetingPixelCustomTemplateBundle/Resources/config/serializer'), 'SevenTag\\Plugin\\SalesManagoCustomTemplateBundle' => ($this->targetDirs[3].'/src/SevenTag/Plugin/SalesManagoCustomTemplateBundle/Resources/config/serializer'), 'SevenTag\\Plugin\\MarketoCustomTemplateBundle' => ($this->targetDirs[3].'/src/SevenTag/Plugin/MarketoCustomTemplateBundle/Resources/config/serializer'), 'SevenTag\\Plugin\\GoogleAdwordsCustomTemplateBundle' => ($this->targetDirs[3].'/src/SevenTag/Plugin/GoogleAdwordsCustomTemplateBundle/Resources/config/serializer'), 'SevenTag\\Plugin\\QualarooCustomTemplateBundle' => ($this->targetDirs[3].'/src/SevenTag/Plugin/QualarooCustomTemplateBundle/Resources/config/serializer'), 'SevenTag\\Plugin\\GoogleAnalyticsCustomTemplateBundle' => ($this->targetDirs[3].'/src/SevenTag/Plugin/GoogleAnalyticsCustomTemplateBundle/Resources/config/serializer'), 'SevenTag\\Component\\Container' => ($this->targetDirs[3].'/src/SevenTag/Api/ContainerBundle/Resources/config/serializer/component'), 'SevenTag\\Component\\Tag' => ($this->targetDirs[3].'/src/SevenTag/Api/TagBundle/Resources/config/serializer/component'), 'SevenTag\\Component\\Trigger' => ($this->targetDirs[3].'/src/SevenTag/Api/TriggerBundle/Resources/config/serializer'), 'SevenTag\\Component\\Variable' => ($this->targetDirs[3].'/src/SevenTag/Api/VariableBundle/Resources/config/serializer/component'), 'SevenTag\\Component\\Condition' => ($this->targetDirs[3].'/src/SevenTag/Api/TriggerBundle/Resources/config/serializer'), 'SevenTag\\AppBundle' => ($this->targetDirs[3].'/src/SevenTag/Api/AppBundle/Resources/config/serializer'), 'SevenTag\\UserBundle' => ($this->targetDirs[3].'/src/SevenTag/Api/UserBundle/Resources/config/serializer'), 'SevenTag\\ContainerBundle' => ($this->targetDirs[3].'/src/SevenTag/Api/ContainerBundle/Resources/config/serializer'), 'SevenTag\\TagBundle' => ($this->targetDirs[3].'/src/SevenTag/Api/TagBundle/Resources/config/serializer'), 'SevenTag\\SecurityBundle' => ($this->targetDirs[3].'/src/SevenTag/Api/SecurityBundle/Resources/config/serializer')));
    ...
    protected function getLiipMonitor_RunnerDefaultService()
    {
        ...
        $instance->addCheck(new \ZendDiagnostics\Check\DirWritable(array(0 => __DIR__, 1 => ($this->targetDirs[2].'/logs'))), 'writable_directory');
        $instance->addCheck(new \Liip\MonitorBundle\Check\SymfonyRequirements(($this->targetDirs[3].'/app/../var/SymfonyRequirements.php')), 'symfony_requirements');
        return $instance;
    }
    ...
    protected function getLoggerService()
    {
        ...
        $instance->pushHandler($this->get('monolog.handler.sentry'));
    ...
    {
        return $this->services['monolog.handler.sentry'] = new \Monolog\Handler\RavenHandler(new \Raven_Client(NULL), 250, true);
    }
    ...
    {
        return $this->services['seven_tag.locale.locale_finder'] = new \SevenTag\Api\AppBundle\Locale\LocaleFinder($this->get('symfony.finder'), ($this->targetDirs[3].'/app'), array(0 => ($this->targetDirs[3].'/app/../src/SevenTag/Plugin')));
    }
    ...
    {
        return $this->services['seven_tag.manifest_containerjs_code_provider'] = new \SevenTag\Api\AppBundle\Plugin\ManifestContainerjsCodeProvider($this->get('seven_tag.manifest_registry'), ($this->targetDirs[3].'/app/../web'));
    }
    ...
    {
        return $this->services['seven_tag_container.code_provider.cdn_url_generator'] = new \SevenTag\Api\ContainerBundle\Cdn\CdnUrlGenerator($this->get('router'), '//yourcdnhostname.com/containers/@id@.js');
    }
    ...
    protected function getSevenTagContainer_ContainerLibrary_TemplateHandlerService()
    {
        ...
        $instance->add(new \SevenTag\Api\ContainerBundle\ContainerLibrary\Template\Handler\ContainerJsHandler('//yourseventag.com'), 1);
    ...
    protected function getSevenTagContainer_ContainerLibrary_TemplateLoaderService()
    {
        ...
        $instance->add(new \SevenTag\Api\ContainerBundle\ContainerLibrary\Template\Loader\FileLoader(($this->targetDirs[3].'/app/Resources/container-lib/licence.dist')), 5);
        $instance->add(new \SevenTag\Api\ContainerBundle\ContainerLibrary\Template\Loader\FileLoader(($this->targetDirs[3].'/app/Resources/container-lib/tagTree.js.dist')), 4);
        $instance->add(new \SevenTag\Api\ContainerBundle\ContainerLibrary\Template\Loader\FileLoader(($this->targetDirs[3].'/app/Resources/container-lib/library.js.dist')), 3);
        $instance->add(new \SevenTag\Api\ContainerBundle\ContainerLibrary\Template\Loader\FileLoader(($this->targetDirs[3].'/app/Resources/container-lib/containerjsConfig.js.dist')), 2);
        $instance->add(new \SevenTag\Api\ContainerBundle\ContainerLibrary\Template\Loader\FileLoader(($this->targetDirs[3].'/app/Resources/container-lib/bootstrap.js.dist')), 1);
        $instance->add(new \SevenTag\Api\ContainerBundle\ContainerLibrary\Template\Loader\FileLoader(($this->targetDirs[3].'/app/../web/container-debugger/debug.js')), 0);
        return $instance;
    }
    ...
    {
        return $this->services['swiftmailer.mailer.default.spool'] = new \Swift_FileSpool(($this->targetDirs[3].'/app/../var/spool/default'));
    }
    ...
    {
        $this->services['translator.default'] = $instance = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, new \Symfony\Component\Translation\MessageSelector(), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => (__DIR__.'/translations'), 'debug' => false, 'resource_files' => array('fr' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.fr.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.fr.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.fr.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.fr.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.fr.yml'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/oauth-server-bundle/FOS/OAuthServerBundle/Resources/translations/FOSOAuthServerBundle.fr.yml'), 6 => ($this->targetDirs[3].'/vendor/sonata-project/notification-bundle/Resources/translations/SonataNotificationBundle.fr.xliff')), 'ro' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ro.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ro.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.ro.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.ro.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.ro.yml')), 'ru' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ru.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ru.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.ru.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.ru.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.ru.yml')), 'sr_Latn' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sr_Latn.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sr_Latn.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.sr_Latn.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.sr_Latn.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.sr_Latn.yml')), 'th' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.th.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.th.xlf'), 2 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.th.yml'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.th.yml')), 'de' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.de.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.de.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.de.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.de.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.de.yml'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/oauth-server-bundle/FOS/OAuthServerBundle/Resources/translations/FOSOAuthServerBundle.de.yml'), 6 => ($this->targetDirs[3].'/vendor/sonata-project/notification-bundle/Resources/translations/SonataNotificationBundle.de.xliff')), 'az' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.az.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.az.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.az.xlf')), 'nb' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.nb.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.nb.xlf'), 2 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.nb.yml'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.nb.yml')), 'es' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.es.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.es.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.es.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.es.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.es.yml'), 5 => ($this->targetDirs[3].'/vendor/sonata-project/notification-bundle/Resources/translations/SonataNotificationBundle.es.xliff')), 'el' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.el.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.el.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.el.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.el.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.el.yml')), 'zh_TW' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.zh_TW.xlf')), 'sl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.sl.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.sl.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.sl.yml'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/oauth-server-bundle/FOS/OAuthServerBundle/Resources/translations/FOSOAuthServerBundle.sl.yml'), 6 => ($this->targetDirs[3].'/vendor/sonata-project/notification-bundle/Resources/translations/SonataNotificationBundle.sl.xliff')), 'da' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.da.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.da.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.da.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.da.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.da.yml')), 'nl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.nl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.nl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.nl.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.nl.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.nl.yml'), 5 => ($this->targetDirs[3].'/vendor/sonata-project/notification-bundle/Resources/translations/SonataNotificationBundle.nl.xliff')), 'mn' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.mn.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.mn.xlf')), 'pt' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.pt.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.pt.xlf'), 2 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.pt.yml'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.pt.yml')), 'hr' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.hr.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.hr.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.hr.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.hr.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.hr.yml')), 'bg' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.bg.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.bg.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.bg.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.bg.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.bg.yml')), 'hy' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.hy.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.hy.xlf')), 'lt' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.lt.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.lt.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.lt.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.lt.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.lt.yml')), 'fa' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.fa.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.fa.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.fa.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.fa.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.fa.yml')), 'tr' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.tr.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.tr.xlf'), 2 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.tr.yml'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.tr.yml')), 'ar' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ar.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ar.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.ar.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.ar.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.ar.yml')), 'pt_BR' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.pt_BR.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.pt_BR.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.pt_BR.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.pt_BR.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.pt_BR.yml')), 'zh_CN' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.zh_CN.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.zh_CN.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.zh_CN.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.zh_CN.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.zh_CN.yml')), 'fi' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.fi.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.fi.xlf'), 2 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.fi.yml'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.fi.yml')), 'sk' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sk.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sk.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.sk.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.sk.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.sk.yml'), 5 => ($this->targetDirs[3].'/vendor/sonata-project/notification-bundle/Resources/translations/SonataNotificationBundle.sk.xliff')), 'he' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.he.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.he.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.he.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.he.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.he.yml')), 'uk' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.uk.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.uk.xlf'), 2 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.uk.yml'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.uk.yml')), 'hu' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.hu.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.hu.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.hu.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.hu.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.hu.yml')), 'sv' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sv.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sv.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.sv.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.sv.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.sv.yml')), 'ja' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ja.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ja.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.ja.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.ja.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.ja.yml')), 'it' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.it.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.it.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.it.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.it.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.it.yml')), 'en' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.en.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.en.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.en.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.en.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.en.yml'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/oauth-server-bundle/FOS/OAuthServerBundle/Resources/translations/FOSOAuthServerBundle.en.yml'), 6 => ($this->targetDirs[3].'/vendor/sonata-project/notification-bundle/Resources/translations/SonataNotificationBundle.en.xliff'), 7 => ($this->targetDirs[3].'/app/Resources/translations/emails.en.yml'), 8 => ($this->targetDirs[3].'/app/Resources/translations/messages.en.yml')), 'no' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.no.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.no.xlf')), 'lb' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.lb.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.lb.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.lb.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.lb.yml')), 'pl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.pl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.pl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.pl.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.pl.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.pl.yml'), 5 => ($this->targetDirs[3].'/app/Resources/translations/messages.pl.yml'), 6 => ($this->targetDirs[3].'/app/Resources/translations/emails.pl.yml')), 'id' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.id.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.id.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.id.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.id.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.id.yml')), 'af' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.af.xlf')), 'eu' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.eu.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.eu.xlf'), 2 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.eu.yml'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.eu.yml')), 'sr_Cyrl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sr_Cyrl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sr_Cyrl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.sr_Cyrl.xlf')), 'sq' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sq.xlf')), 'ca' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ca.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ca.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.ca.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.ca.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.ca.yml')), 'et' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.et.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.et.xlf'), 2 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.et.yml')), 'cs' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.cs.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.cs.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.cs.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.cs.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.cs.yml'), 5 => ($this->targetDirs[3].'/vendor/sonata-project/notification-bundle/Resources/translations/SonataNotificationBundle.cs.xliff')), 'gl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.gl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.gl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.gl.xlf')), 'vi' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.vi.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.vi.xlf'), 2 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.vi.yml'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.vi.yml')), 'cy' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.cy.xlf')), 'lv' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.lv.xlf'), 1 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.lv.yml'), 2 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.lv.yml')), 'pt_PT' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.pt_PT.xlf')), 'ua' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.ua.xlf')))), array());
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/vendor/liip/monitor-bundle/Resources/views'), 'LiipMonitor');
        $instance->addPath(($this->targetDirs[3].'/vendor/nelmio/api-doc-bundle/Nelmio/ApiDocBundle/Resources/views'), 'NelmioApiDoc');
        $instance->addPath(($this->targetDirs[3].'/src/SevenTag/Api/ContainerBundle/Resources/views'), 'SevenTagContainer');
        $instance->addPath(($this->targetDirs[3].'/src/SevenTag/Api/UserBundle/Resources/views'), 'SevenTagUser');
        $instance->addPath(($this->targetDirs[3].'/src/SevenTag/Api/AppBundle/Resources/views'), 'SevenTagApp');
        $instance->addPath(($this->targetDirs[3].'/src/SevenTag/Plugin/PiwikCustomTemplateBundle/Resources/views'), 'SevenTagPluginPiwikCustomTemplate');
        $instance->addPath(($this->targetDirs[3].'/src/SevenTag/Plugin/ClickTaleCustomTemplateBundle/Resources/views'), 'SevenTagPluginClickTaleCustomTemplate');
        $instance->addPath(($this->targetDirs[3].'/src/SevenTag/Plugin/CrazyEggCustomTemplateBundle/Resources/views'), 'SevenTagPluginCrazyEggCustomTemplate');
        $instance->addPath(($this->targetDirs[3].'/src/SevenTag/Plugin/SentryBundle/Resources/views'), 'SevenTagPluginSentry');
        $instance->addPath(($this->targetDirs[3].'/src/SevenTag/Plugin/FacebookRetargetingPixelCustomTemplateBundle/Resources/views'), 'SevenTagPluginFacebookRetargetingPixelCustomTemplate');
        $instance->addPath(($this->targetDirs[3].'/src/SevenTag/Plugin/SalesManagoCustomTemplateBundle/Resources/views'), 'SevenTagPluginSalesManagoCustomTemplate');
        $instance->addPath(($this->targetDirs[3].'/src/SevenTag/Plugin/MarketoCustomTemplateBundle/Resources/views'), 'SevenTagPluginMarketoCustomTemplate');
        $instance->addPath(($this->targetDirs[3].'/src/SevenTag/Plugin/GoogleAdwordsCustomTemplateBundle/Resources/views'), 'SevenTagPluginGoogleAdwordsCustomTemplate');
        $instance->addPath(($this->targetDirs[3].'/src/SevenTag/Plugin/QualarooCustomTemplateBundle/Resources/views'), 'SevenTagPluginQualarooCustomTemplate');
        $instance->addPath(($this->targetDirs[3].'/src/SevenTag/Plugin/GoogleAnalyticsCustomTemplateBundle/Resources/views'), 'SevenTagPluginGoogleAnalyticsCustomTemplate');
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addYamlMappings(array(0 => ($this->targetDirs[3].'/src/SevenTag/Api/ContainerBundle/Resources/config/validation.yml'), 1 => ($this->targetDirs[3].'/src/SevenTag/Api/TagBundle/Resources/config/validation.yml'), 2 => ($this->targetDirs[3].'/src/SevenTag/Api/UserBundle/Resources/config/validation.yml'), 3 => ($this->targetDirs[3].'/src/SevenTag/Api/SecurityBundle/Resources/config/validation.yml'), 4 => ($this->targetDirs[3].'/src/SevenTag/Api/TriggerBundle/Resources/config/validation.yml'), 5 => ($this->targetDirs[3].'/src/SevenTag/Api/VariableBundle/Resources/config/validation.yml')));
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'seventag_domain' => '//yourseventag.com',
            'mailer_sender' => 'example@example.com',
            'database_driver' => 'pdo_mysql',
            'database_host' => 'localhost',
            'database_port' => NULL,
            'database_name' => 'seventag1',
            'database_user' => 'seventag',
            'database_password' => 'QdXrga5FdpN2Xosp',
            'database_path' => NULL,
            ...
            'mailer_spool' => array(
                'type' => 'file',
                'path' => ($this->targetDirs[3].'/app/../var/spool'),
            ),
            'mailer_delivery_address' => NULL,
            'locale' => 'en',
            'secret' => '&-2_W\\$/N=auNLuE?NM6:G:w-V{5,_',
            'datetime_default_format' => 'Y-m-d\\TH:i:sO',
            'seventag_licence_template_path' => ($this->targetDirs[3].'/app/Resources/container-lib/licence.dist'),
            'seventag_tagtree_template_path' => ($this->targetDirs[3].'/app/Resources/container-lib/tagTree.js.dist'),
            'seventag_containerjs_config_path' => ($this->targetDirs[3].'/app/Resources/container-lib/containerjsConfig.js.dist'),
            'seventag_javascript_debugger_path' => ($this->targetDirs[3].'/app/../web/container-debugger/debug.js'),
            'seventag_javascript_library_path' => ($this->targetDirs[3].'/app/Resources/container-lib/library.js.dist'),
            'seventag_javascript_bootstrap_path' => ($this->targetDirs[3].'/app/Resources/container-lib/bootstrap.js.dist'),
            'seventag_javascript_cache_dir' => ($this->targetDirs[3].'/app/../web/containers'),
            'seventag_javascript_url_template' => '//yourcdnhostname.com/containers/@id@.js',
            'seventag_container_library_cdn' => array(
                'enabled' => false,
                'service' => NULL,
            ...
            'sentry_dsn' => NULL,
            'web_dir' => ($this->targetDirs[3].'/app/../web'),
            'seventag_noscript_backend' => 'sonata.notification.backend.runtime',
            'oauth2_secret' => '49dsi2td1fi84cwo0c008wkc0k04cgoow8ss4ock80c44ckg00',
            'random_id' => '3fyzytq7aayogkcswokkss0ksoo4g4c4soocsc88wogccs88ks',
            ...
            'swiftmailer.spool.default.file.path' => ($this->targetDirs[3].'/app/../var/spool/default'),
            ...
            'liip_monitor.check.writable_directory.default' => array(
                0 => __DIR__,
                1 => ($this->targetDirs[2].'/logs'),
            ),
            'liip_monitor.check.writable_directory.0.default' => __DIR__,
            'liip_monitor.check.writable_directory.1.default' => ($this->targetDirs[2].'/logs'),
            'liip_monitor.check.writable_directory.class' => 'ZendDiagnostics\\Check\\DirWritable',
            'liip_monitor.check.symfony_requirements.file.default' => ($this->targetDirs[3].'/app/../var/SymfonyRequirements.php'),
                ...
                'groups' => array(
                    'default' => array(
                        ...
                        'symfony_requirements' => array(
                            'file' => ($this->targetDirs[3].'/app/../var/SymfonyRequirements.php'),
                        ),
                    ),
                ),
            ),
            ...
            'seven_tag_app.plugins_dir' => array(
                0 => ($this->targetDirs[3].'/app/../src/SevenTag/Plugin'),
            ),
