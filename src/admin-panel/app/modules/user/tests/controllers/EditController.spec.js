...
describe('Unit: EditController', () => {
    ...
    var EditController, userResource, $scope;
    ...
    beforeEach(inject(
        ($controller, $rootScope) => {
            ...
            EditController = $controller('clearcode.tm.user.EditController', {
                $scope: $scope
            });
    ...
    it('should get call get method from userResource', () => {
